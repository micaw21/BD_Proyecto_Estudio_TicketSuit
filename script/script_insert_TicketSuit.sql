...
(1, 'El viaje de Chihiro', 125, 1, 5, 'Una niña que se aventura en un mundo mágico mientras busca una forma de salvar a sus padres.', 'Japón', 1),
(2, 'Los Vengadores', 143, 2, 2, 'Un grupo de superhéroes se une para enfrentar una amenaza global.', 'EE.UU.', 1),
...
(7, 'La La Land', 128, 2, 7, 'Dos artistas en Los Ángeles luchan por lograr sus sueños mientras enfrentan desafíos en su relación.', 'EE.UU.', 1),
(8, 'Coco', 105, 1, 8, 'Un niño viaja al mundo de los muertos para descubrir la verdad sobre su familia.', 'México', 1),
(9, 'El Origen', 148, 4, 9, 'Un ladrón con la capacidad de entrar en los sueños de las personas intenta realizar el trabajo definitivo.', 'EE.UU.', 1),
